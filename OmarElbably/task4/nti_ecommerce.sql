...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2737554314ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="283">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nti_ecommerce&table=wishlist">`nti_ecommerce`.`wishlist`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nti_ecommerce&table=subcategories">`nti_ecommerce`.`subcategories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nti_ecommerce&table=users">`nti_ecommerce`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nti_ecommerce&table=order_product">`nti_ecommerce`.`order_product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nti_ecommerce&table=product_spec">`nti_ecommerce`.`product_spec`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nti_ecommerce&table=product">`nti_ecommerce`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nti_ecommerce&table=specs">`nti_ecommerce`.`specs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nti_ecommerce&table=reviews">`nti_ecommerce`.`reviews`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nti_ecommerce&table=regions">`nti_ecommerce`.`regions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nti_ecommerce&table=products">`nti_ecommerce`.`products`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2a453440637430243563707173287b33">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="283"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="nti_ecommerce" targettable="regions">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `nti_ecommerce`.`regions` ( `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT ,  `status` BOOLEAN NOT NULL ,  `name_en` VARCHAR(32) NOT NULL ,  `name_ar` VARCHAR(32) NOT NULL ,  `city_id` BIGINT(20) UNSIGNED NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="nti_ecommerce" targettable="orders">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `nti_ecommerce`.`orders` ( `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT ,  `order_number` BIGINT(20) UNSIGNED NOT NULL ,  `total` TINYINT NOT NULL DEFAULT &#039;0&#039; ,  `status` BOOLEAN NOT NULL ,  `address_id` BIGINT(20) UNSIGNED NOT NULL ,  `coupon_id` BIGINT(20) UNSIGNED NOT NULL ,  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,  `updated_at` TIMESTAMP on update CURRENT_TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,  `delivered_at` DATETIME NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nti_ecommerce" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="nti_ecommerce" targettable="admins">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `nti_ecommerce`.`admins` ( `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT ,  `status` BOOLEAN NOT NULL COMMENT &#039;1= active\r\n0= not active&#039; ,  `gender` ENUM(&#039;f&#039;,&#039;m&#039;) NULL ,  `first_name` VARCHAR(32) NOT NULL ,  `last_name` VARCHAR(32) NOT NULL ,  `email` VARCHAR(64) NOT NULL ,  `password` VARCHAR(255) NOT NULL ,  `phone` VARCHAR(11) NOT NULL ,  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,  `updated_at` TIMESTAMP on update CURRENT_TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,    PRIMARY KEY  (`id`),    UNIQUE  (`email`),    UNIQUE  (`password`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nti_ecommerce" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="nti_ecommerce" targettable="coupons">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `nti_ecommerce`.`coupons` ( `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT ,  `code` BIGINT(5) UNSIGNED NOT NULL ,  `discount` TINYINT UNSIGNED NOT NULL ,  `discount_type` VARCHAR(32) NOT NULL ,  `mini_order_value` SMALLINT(4) UNSIGNED NOT NULL ,  `max_discount_value` SMALLINT(3) UNSIGNED NOT NULL ,  `max_number_of_usage` TINYINT(2) UNSIGNED NOT NULL ,  `max_number_of_usage_per_user` TINYINT(2) UNSIGNED NOT NULL ,  `start_date_time` DATETIME NOT NULL ,  `end_date_time` DATETIME NOT NULL ,  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,  `updated_at` TIMESTAMP on update CURRENT_TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nti_ecommerce" targettable="addresses">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `addresses`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="nti_ecommerce" targettable="brands">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `brands`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="nti_ecommerce" targettable="carts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `carts`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="nti_ecommerce" targettable="categories">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `categories`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="nti_ecommerce" targettable="cities">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `regions`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="nti_ecommerce" targettable="reviews">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `reviews`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nti_ecommerce" targettable="specs">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `specs`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nti_ecommerce" targettable="subcategories">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="nti_ecommerce" targettable="wishlist">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `wishlist`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="nti_ecommerce" targettable="product">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `nti_ecommerce`.`product` ( `product_id` BIGINT(20) UNSIGNED NOT NULL ,  `spec_id` BIGINT(20) UNSIGNED NOT NULL ,  `value` LONGTEXT NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="nti_ecommerce" targettable="product_spec">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">
            RENAME TABLE `nti_ecommerce`.`product`
                  TO `nti_ecommerce`.`product_spec`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nti_ecommerce" targettable="product_spec">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `product_spec`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="nti_ecommerce" targettable="order_product">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `nti_ecommerce`.`order_product` ( `product_id` BIGINT(20) UNSIGNED NOT NULL ,  `order_id` BIGINT(20) UNSIGNED NOT NULL ,  `quantity` TINYINT(2) UNSIGNED NOT NULL ,  `price` DECIMAL(8.2) UNSIGNED NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nti_ecommerce" targettable="users">
                            <div class="action_content">
